...
| PD-003 | Define the current `Property` concept boundary without authorizing lifecycle or validation rules. | EDD v1.0 / Product Owner authority | Awaiting Product Owner Decision | Blocked | S07 |
| PD-004 | Capture exclusion and acceptance principles that prevent unauthorized domain behaviour. | EDD v1.0 / Product Owner authority | Awaiting Product Owner Decision | Blocked | S07 |
